...
- 2026-04-14 `[Code]` `synology docker logs` — SSH fallback via `docker logs --tail` when HTTP API returns error 114 (CM24.x Compose containers)
- 2026-04-14 `[Code]` `synology docker pull <image>` — SSH `docker pull` with YES confirmation; HTTP API removed in CM24.x
